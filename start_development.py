#!/usr/bin/env python3
"""
SuperSpeedCalc Server 开发环境启动脚本
端口: 8000 (开发环境)
"""
...
def main():
    """主函数"""
    print("🚀 SuperSpeedCalc Server 开发环境启动脚本")
    print("=" * 40)
    ...
    # 配置详细日志
    app.logger.info("=" * 50)
    app.logger.info("🚀 SuperSpeedCalc Server 开发环境启动")
    app.logger.info("=" * 50)
    ...
    print("💾 数据库文件: instance/app_development.db")
    print("📝 详细日志将输出到控制台和 logs/app_development.log 文件")
    print("\n按 Ctrl+C 停止服务器")
    print("=" * 40)
